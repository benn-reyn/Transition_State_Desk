...
* **Macroeconomic Data Input** (Daily Yahoo Finance & FRED)
    * *Then feeds into:*
* **MSIAH-VAR Regime Model** (Smooths Calm vs. Bear Probabilities)
    * *Then feeds into:*
* **Regime-Conditional GARCH** (Generates Blended Volatility Forecasts)
    * *Then maps to:*
* **Kole & van Dijk (2023) IRFs** (Calculates Closed-Form Shock Spillovers)
